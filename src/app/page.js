      ...
      <div className="rounded-lg">
        <div>
          ...
          <div className="flex flex-row justify-center mt-4 rounded-lg flex-wrap gap-4">
            <div>
            <iframe width="360" height="200" className="rounded-lg" src="https://www.youtube.com/embed/DSj8K4wcoz4?si=LvUCZ0_xD0hu-bEI?autoplay=1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        
            </div>
          
          <div>
          <iframe width="360" height="200" className="rounded-lg" src="https://www.youtube.com/embed/CDyx2kayhGQ?si=LT8m13Wr_67fjS6h" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
